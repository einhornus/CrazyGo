...
public class LeelaBotMain {
    public static void main(String[] args)throws IOException{
        ...
        //Bot leela10 = new Bot("leela4", pass, "hidden-move-go", "board_size-9|handi-0|time-b3600#60#5", true);

        Bot leela6 = new Bot("leela_robot2", pass, "go", "board_size-19|handi-1|time-b3600#60#5", true);
        /*
        for(int i = 0; i<10; i++){
            if(i%2 == 0) {
